...
export const historyEvents = Array.from({ length: 5 }, (_, index) => ({ id: `h-0${index + 1}`, year: '资料整理中', date: '时间待核实', title: `历史事件${index + 1}（演示）`, description: '资料整理中 / 待史料核实。', image: images.historyPaper, isPlaceholder: true }))
